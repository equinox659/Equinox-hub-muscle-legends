...
local lang = {
    ES = {
        title = "Muscle legends | AFX|ALPHA FOR X SCRIPT", notify = "¡Idioma cambiado a Español!",
    ...
    EN = {
        title = "Muscle legends | AFX|ALPHA FOR X SCRIPT", notify = "Language changed to English!",
